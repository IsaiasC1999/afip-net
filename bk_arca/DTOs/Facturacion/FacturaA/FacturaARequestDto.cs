...
{
    public class FacturaARequestDto
    {
        [Required]
        ...
        // 6 = Factura B (fijo)
        public TipoComprobante TipoComprobante { get; set; } = TipoComprobante.FacturaA;
        ...
        // Receptor
        [Required]
        public TipoDocumento TipoDocumentoReceptor { get; set; } = TipoDocumento.CUIT; // 99
